...
python demo/glip_demo.py D:/project/GLIP/image/apparel/dress configs/glip/glip_atss_swin-l_fpn_dyhead_pretrain_mixeddata.py --weights checkpoints/glip/glip_l_mmdet-abfe026b.pth --texts "pants . skirt . dress . t-shirt . shirt . sweater . coat . suit . bag . wallet . backpack . suitcase . heels . sneakers . shoes . watch . necklace . bracelet . ring . earrings ." --custom-entities
